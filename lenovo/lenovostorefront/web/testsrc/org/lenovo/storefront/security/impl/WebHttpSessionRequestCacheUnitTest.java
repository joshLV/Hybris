...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/lenovostorefront/electronics/en",
						"https://electronics.local:9002/lenovostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/lenovostorefront/electronics/en",
						"https://electronics.local:9002/lenovostorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/lenovostorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/lenovostorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/lenovostorefront/electronics/en",
						"https://electronics.local:9002/lenovostorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/lenovostorefront",
						"https://electronics.local:9002/lenovostorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/lenovostorefront",
						"https://electronics.local:9002/lenovostorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/lenovostorefront/electronics/en",
						"https://electronics.local:9002/lenovostorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
