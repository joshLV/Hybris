 ...
 *
 */
package org.lenovo.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('lenovostorefront.generic.cms.component.controller.authorized.group')}")
