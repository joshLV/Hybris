 ...
 *  
 */
package org.lenovo.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(LenovoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(LenovoFulfilmentProcessConstants.PARENT_PROCESS);
