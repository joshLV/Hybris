...
import org.lenovo.test.constants.LenovoTestConstants;
import org.lenovo.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = LenovoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/lenovotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/lenovotest/import/reviews.impex");
			...
			importImpexFile(context, "/lenovotest/import/cstickets.impex");
		}
	}
}
